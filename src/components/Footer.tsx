...
const socialLinks = [
	...
	{ icon: Instagram, href: "https://www.instagram.com/notably.ai/", label: "Instagram" },
	{ icon: Linkedin, href: "https://www.linkedin.com/company/notably-ai-india/", label: "LinkedIn" },
];
